...
Xtrain_path = "hf://datasets/Andrew2505/Tourism-package-project/Xtrain.csv"
Xtest_path = "hf://datasets/Andrew2505/Tourism-package-project/Xtest.csv"
ytrain_path = "hf://datasets/Andrew2505/Tourism-package-project/ytrain.csv"
ytest_path = "hf://datasets/Andrew2505/Tourism-package-project/ytest.csv"
...
# List of categorical and numerical features in the dataset
...
with mlflow.start_run():
    ...
    # Log the best parameters seperately in the main run
...
# Save best model
joblib.dump(best_model, "best_tourism_package_model.joblib")

# Upload to Hugging Face
repo_id = "Andrew2505/Tourism-package-project"
repo_type = "model"
